...
contract Sillysloths is ERC721, Ownable {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;

    using SafeMath for uint256;

    string public IWWON_PROVENANCE = "Silly Sloth";
    ...
    uint public constant pertokenprice = 0.7;
    uint256 constant public maxTokenPurchasePresale =  5800;

    uint256 public MAX_TOKEN=100000;
    ...
    constructor() public ERC721("Silly", "Silly Sloth") {
    }
